...
const translations = {
  en: {
    ...
    card3_badge: 'Lab 02', card3_title: 'Big Data & Hadoop Processing', card3_sub: 'MapReduce & Analytics',
    card3_desc: 'Hadoop cluster deployment and distributed data processing on quality datasets using MapReduce and charting visualizations.',
    card3_link: 'View Lab Report & Code →',
    card4_badge: 'Theory 02', card4_title: 'AQUA-Fed Architecture', card4_sub: 'Federated Data Management 2.0',
    card4_desc: 'Advanced research on federated learning applied to management ecosystems, privacy-preserving techniques (FedAvg), and taxonomy of federated models.',
    card4_link: 'Open Digital Report →',
  ...
  hi: {
    ...
    card3_badge: 'लैब 02', card3_title: 'बिग डेटा और हडूप प्रसंस्करण', card3_sub: 'मैपरिड्यूस और एनालिटिक्स',
    card3_desc: 'मैपरिड्यूस का उपयोग करके गुणवत्ता डेटासेट पर हडूप क्लस्टर परिनियोजन और वितरित डेटा प्रसंस्करण।',
    card3_link: 'लैब रिपोर्ट और कोड देखें →',
    card4_badge: 'थ्योरी 02', card4_title: 'AQUA-Fed आर्किटेक्चर', card4_sub: 'फेडरेटेड डेटा प्रबंधन 2.0',
    card4_desc: 'मंचों पर लागू फेडरेटेड लर्निंग, गोपनीयता-संरक्षण तकनीकों (FedAvg) पर उन्नत शोध।',
    card4_link: 'डिजिटल रिपोर्ट खोलें →',
  ...
  kn: {
    ...
    card3_badge: 'ಲ್ಯಾಬ್ 02', card3_title: 'ಬಿಗ್ ಡೇಟಾ & ಹಡೂಪ್', card3_sub: 'ಮ್ಯಾಪ್‌ರೆಡ್ಯೂಸ್ ಅನಾಲಿಟಿಕ್ಸ್',
    card3_desc: 'ಹಡೂಪ್ ಕ್ಲಸ್ಟರ್ ನಿಯೋಜನೆ ಮತ್ತು ಮ್ಯಾಪ್‌ರೆಡ್ಯೂಸ್ ಬಳಸಿಕೊಂಡು ವಿತರಿತ ಡೇಟಾ ಪ್ರಕ್ರಿಯೆ.',
    card3_link: 'ಲ್ಯಾಬ್ ವರದಿ ಮತ್ತು ಕೋಡ್ ವೀಕ್ಷಿಸಿ →',
    card4_badge: 'ಥಿಯರಿ 02', card4_title: 'AQUA-Fed ಆರ್ಕಿಟೆಕ್ಚರ್', card4_sub: 'ಫೆಡರೇಟೆಡ್ ಡೇಟಾ ನಿರ್ವಹಣೆ 2.0',
    card4_desc: 'ಫೆಡರೇಟೆಡ್ ಲರ್ನಿಂಗ್, ಗೋಪ್ಯತೆ (FedAvg) ಮತ್ತು ಫೆಡರೇಟೆಡ್ ಮಾದರಿಗಳ ಕುರಿತು ಸುಧಾರಿತ ಸಂಶೋಧನೆ.',
    card4_link: 'ಡಿಜಿಟಲ್ ವರದಿ ತೆರೆಯಿರಿ →',
  ...
  lad: {
    ...
    card3_badge: 'ཚོད་ལྟ་ 02', card3_title: 'ཧ་ཌུཔ་དང་གནས་ཚུལ་ཆེན་པོ', card3_sub: 'MapReduce དབྱེ་ཞིབ',
    card3_desc: 'ཧ་ཌུཔ་མ་ལག་དང་MapReduce བཀོལ་ནས་གནས་ཚུལ་དབྱེ་ཞིབ།',
    card3_link: 'ཚོད་ལྟའི་ཡིག་ཆ་ལྟ་བ →',
    card4_badge: 'རྒྱུས་ལོན་ 02', card4_title: 'AQUA-Fed བཟོ་བཀོད', card4_sub: 'སྦྲེལ་མའི་གནས་ཚུལ་སྒྲིག་འཛིན་ 2.0',
    card4_desc: 'སྦྲེལ་མའི་སྦྱང་བ་དང་FedAvg སོགས་ཀྱི་ཞིབ་འཇུག།',
    card4_link: 'ཡིག་ཆ་ཕྱེ་བ →',
  ...
  ml: {
    ...
    card3_badge: 'ലാബ് 02', card3_title: 'ബിഗ് ഡാറ്റ & ഹഡൂപ്', card3_sub: 'മാപ്പ്റെഡ്യൂസ് അനലിറ്റിക്സ്',
    card3_desc: 'മാപ്പ്റെഡ്യൂസ് ഉപയോഗിച്ചുള്ള ഡാറ്റ വിശകലനം ഗ്രാഫുകൾ വഴി.',
    card3_link: 'ലാബ് റിപ്പോർട്ടും കോഡും കാണുക →',
    card4_badge: 'തിയറി 02', card4_title: 'AQUA-Fed ആർക്കിടെക്ചർ', card4_sub: 'ഫെഡറേറ്റഡ് ഡാറ്റ മാനേജ്മെന്റ് 2.0',
    card4_desc: 'ഫെഡറേറ്റഡ് ലേണിംഗ്, പ്രൈവസി (FedAvg) ഗവേഷണം.',
    card4_link: 'ഡിജിറ്റൽ റിപ്പോർട്ട് തുറക്കുക →',
  ...
  gu: {
    ...
    card3_badge: 'લેબ 02', card3_title: 'બિગ ડેટા અને હડૂપ', card3_sub: 'મેપરીડ્યુસ એનાલિટિક્સ',
    card3_desc: 'હડૂપ ક્લસ્ટર ડિપ્લોયમેન્ટ અને મેપરીડ્યુસનો ઉપયોગ કરીને ડેટા પ્રોસેસિંગ.',
    card3_link: 'લેબ રિપોર્ટ અને કોડ જુઓ →',
    card4_badge: 'સિદ્ધાંત 02', card4_title: 'AQUA-Fed આર્કિટેક્ચર', card4_sub: 'ફેડરેટેડ ડેટા 2.0',
    card4_desc: 'ફેડરેટેડ લર્નિંગ અને FedAvg પર ઉન્નત સંશોધન.',
    card4_link: 'ડિજિટલ રિપોર્ટ ખોલો →',
  ...
  bn: {
    ...
    card3_badge: 'ল্যাব ০২', card3_title: 'বিগ ডেটা ও হাডুপ', card3_sub: 'ম্যাপরিডিউস অ্যানালিটিক্স',
    card3_desc: 'হাডুপ ক্লাস্টার স্থাপন ও ম্যাপরিডিউস ব্যবহার করে ডেটা বিশ্লেষণ।',
    card3_link: 'ল্যাব রিপোর্ট ও কোড দেখুন →',
    card4_badge: 'তত্ত্ব ০২', card4_title: 'AQUA-Fed আর্কিটেকচার', card4_sub: 'ফেডারেটেড ডেটা ২.০',
    card4_desc: 'ফেডারেটেড লার্নিং এবং FedAvg নিয়ে উন্নত গবেষণা।',
    card4_link: 'ডিজিটাল রিপোর্ট খুলুন →',
  ...
  ur: {
    ...
    card3_badge: 'لیب 02', card3_title: 'بگ ڈیٹا اور ہڈوپ', card3_sub: 'میپ ریڈیوس اینالیٹکس',
    card3_desc: 'ہڈوپ کلسٹر اور میپ ریڈیوس کا استعمال کرتے ہوئے ڈیٹا انالیسس۔',
    card3_link: 'لیب رپورٹ اور کوڈ دیکھیں →',
    card4_badge: 'نظریہ 02', card4_title: 'AQUA-Fed آرکیٹیکچر', card4_sub: 'فیڈریٹڈ ڈیٹا 2.0',
    card4_desc: 'فیڈریٹڈ لرننگ اور FedAvg پر جدید تحقیق۔',
    card4_link: 'ڈیجیٹل رپورٹ کھولیں →',
